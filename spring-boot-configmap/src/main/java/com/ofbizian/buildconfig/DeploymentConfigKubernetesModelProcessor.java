...
public class DeploymentConfigKubernetesModelProcessor {
    ...
    private List<Volume> getVolumes(){
        ...
        Volume secret = new Volume();
        secret.setSecret(new SecretVolumeSource("client-truststore"));
        secret.setName("truststore");
    

        return new ImmutableList.Builder<Volume>().add(secret).build();
    ...
    private List<DeploymentTriggerPolicy> getTriggers() {
        ...
        from.setName("spring-boot-configmap:latest");
        ...
        imageChangeParms.setContainerNames(Lists.newArrayList("spring-boot-configmap"));
    ...
    private List<ContainerPort> getPorts() {
        ...
        jolokia.setContainerPort(8778);//8778
    ...
    private Container getContainers() {
        ...
        container.setImage("${IS_PULL_NAMESPACE}/spring-boot-configmap:latest");
        container.setImagePullPolicy("Always");
        container.setName("spring-boot-configmap");
    ...
    private Map<String, String> getSelectors() {
        ...
        selectors.put("app", "spring-boot-configmap");
        selectors.put("deploymentconfig", "spring-boot-configmap");
